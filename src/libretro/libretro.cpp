...
void retro_set_environment(retro_environment_t cb)
{
   ...
   log_cb(RETRO_LOG_INFO, "melonDS JIT: armeabi-v7a/AArch32 backend active (M17/M18/M22C/M27/M28/M29/M30/M31); concise feature detail and kill-switch states logged at JIT init (melonDS-JIT tag)\n");
